...
const ACTIVE_DELIVERIES = [
  {
    id: 1,
    from: 'Taj Palace Kitchen',
    to: 'Akshaya Patra Foundation',
    driver: 'Rajesh K.',
    status: 'in_transit',
    food: 'Dal Makhani + Rice (50 servings)',
    eta: 12,
    distance: 5.2,
    progress: 65,
  },
  {
    ...
    driver: 'Amit S.',
    status: 'picked_up',
    food: 'Paneer Masala + Naan (30 servings)',
    eta: 22,
    distance: 8.1,
    progress: 35,
  },
  {
    id: 3,
    from: 'Royal Biryani Centre',
    to: 'Feeding India',
    driver: 'Suresh P.',
    status: 'assigned',
    food: 'Chicken Biryani (40 servings)',
    eta: 35,
    distance: 12.3,
    progress: 10,
  },
